...
const features = [
    {
        ...
        content: "Control your releases with surgical precision. Our flags are integrated into the neural core, allowing for automatic rollback if performance metrics degrade.",
        image:
            "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=1400&auto=format&fit=crop",
        specBox: { label: "SPEC: propagation_latency < 2ms", target: "TARGET: edge_runtime_v3" },
    ...
    },
    {
        ...
        content: "Optimize user experiences through controlled experiments and real-time performance analysis. Compare multiple variations, measure key metrics, and confidently deploy the best-performing version.",
        image:
    ...
    },
    {
        ...
        content: "Zero-trust secret management. Inject credentials directly into your runtimes without ever exposing them to logs or environment variables.",
        image:
    ...
    },
    {
        ...
        content: "A hyper-scale event bus that captures every state change across your infrastructure. Process 10M+ events per second with sub-millisecond latency.",
        image:
    ...
    },
    {
        ...
        content: "Reconstruct user sessions with frame-perfect accuracy. Automatically linked to backend traces, so you can see exactly why a button click failed.",
        image:
    ...
    },
    {
        ...
        content: "Deploy hyper-targeted feedback loops. Correlate user satisfaction scores directly with app performance and technical metrics in real-time.",
    ...
    },
    {
        ...
        content: "Don't just log errors—understand them. Zelery automatically groups exceptions and identifies the exact line of code and environmental condition responsible.",
        image:
    ...
    },
    {
        ...
        content: "Adaptive throttling that learns from your traffic patterns. Protect your upstream services with intelligent queuing and token-bucket algorithms.",
        image:
    ...
    },
    {
        ...
        content: "Automate your engineering updates. Generate high-fidelity reports that combine business impact metrics with deep-dive technical performance analysis.",
        image:
            "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1400&auto=format&fit=crop",
                ...
                <div className="timeline">
                    {features.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="timeline-dot" style={{ "--dot-clr": item.dotColor }} />
                            ...
                            <div className="timeline-card info-card">
                                ...
                                {item.specBox && (
                                    <div className="spec-box">
                                        ...
                                        {item.specBox.target && <div className="spec-sub">{item.specBox.target}</div>}
                                    </div>
                                )}
                                ...
                                {item.pills && (
                                    <div className="pill-wrapper">
                                        {item.pills.map((pill, pIdx) => (
                                            <span key={pIdx} className={`pill ${item.id === '05' ? 'pill-green' : 'pill-blue'}`}>
                                                {pill}
                                            </span>
                                        ))}
                                    </div>
                                ...
                                {item.errorConsole && (
                                    <div className="error-console">
                                        ...
                                        <div className="error-subtitle">{item.errorConsole.subtitle}</div>
                                    </div>
                                )}

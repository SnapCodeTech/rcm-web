        ...
        <div className="defense-container">
          <div className="defense-info">
            ...
            <p className="defense-description">
              Traditional security is reactive. Zelisy uses a proprietary neural
            ...
            <div className="defense-features">
              <div className="feature-item">
                ...
                <div className="feature-text">
                  ...
                  <p>
                    Maps normal system behavior to instantly flag deviations
                    without pre-defined signatures.
                  </p>
                </div>
              </div>
              ...
              <div className="feature-item">
                ...
                <div className="feature-text">
                  ...
                  <p>
                    Simulates potential attack paths in real-time to harden
        ...
        <div className="zk-container">
          <div className="zk-header">
            ...
            <p className="zk-subtitle">
              We can't see your data because only you hold the keys. Complete
              sovereignty over your observability pipeline.
            </p>
          </div>
          ...
          <div className="zk-grid">
            <div className="zk-card">
              ...
              <p>
                Bring Your Own Key (BYOK) through AWS KMS, HashiCorp Vault, or
                GCP KMS. We never store master keys.
              </p>
            </div>
            ...
            <div className="zk-card">
              ...
              <p>
                All telemetry and traffic is wrapped in the latest TLS protocols
            ...
            <div className="zk-card">
              ...
              <p>
                Granular control to encrypt specific sensitive fields (PII/PHI)
                before they ever leave your VPC.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="reliability-container">
          ...
          <div className="reliability-info">
            ...
            <p className="reliability-description">
              ...
              never stops. Even during regional cloud outages, Zelisy persists.
            </p>
        ...
        <div className="matrix-container">
          <div className="matrix-header">
            ...
            <p className="matrix-subtitle">
              Beyond observation: active countermeasures deployed at the network
              edge.
            </p>
          </div>
          ...
          <div className="matrix-grid">
            <div className="matrix-card">
              ...
              <p>
                Instantaneous removal of malicious signatures and malformed
                packets before they reach your gateway.
              </p>
            </div>
            ...
            <div className="matrix-card">
              ...
              <p>
                Multi-vector protection against sophisticated application-layer
                attacks with auto-scaling ingress.
              </p>
            </div>
            ...
            <div className="matrix-card">
              ...
              <p>
                FIPS 140-2 Level 3 physical isolation for cryptographic
                operations and root of trust management.
              </p>
            </div>
            ...
            <div className="matrix-card">
              ...
              <p>
                Continuous authentication for every service-to-service request
                using short-lived SPIFFE IDs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="latency-container">
          <div className="latency-info">
            ...
            <p className="latency-description">
              ...
              ingestion fabric delivers industry-leading performance across
              every major region.
            </p>
          ...
          <div className="latency-visual">
            <div className="latency-card">
              ...
              <div className="bar-chart-container">
                <div
                  className="chart-bar bar-muted"
                  style={{ height: "45%" }}
                />
                <div
                  className="chart-bar bar-muted-tall"
                  style={{ height: "65%" }}
                />
                <div
                  className="chart-bar bar-muted"
                ...
                />
                <div
                  className="chart-bar bar-muted-short"
                  style={{ height: "30%" }}
                />
                <div
                ...
                <div
                  className="chart-bar bar-purple-muted"
                  style={{ height: "60%" }}
                />
              </div>
            </div>
        ...
        <div className="healing-container">
          <div className="healing-info">
            ...
            <p className="healing-description">
              Zelisy isn't just watching; it's acting. Our autonomous response
              layer triggers rollbacks and localized kill-switches when
              anomalies exceed defined thresholds.
            </p>
            <div className="healing-cards-stack">
              <div className="healing-card">
                ...
                <div className="card-text">
                  ...
                  <p>
                    Instant isolation of compromised services to prevent lateral
                    movement.
                  </p>
                </div>
              </div>
              ...
              <div className="healing-card">
                ...
                <div className="card-text">
                  ...
                  <p>
                    Seamless return to last known-good configuration in under
                    1.5 seconds.
                  </p>
                </div>
              </div>
        ...
        <div className="support-container">
          <div className="support-header">
            ...
            <p className="support-subtitle">
              Enterprise security is a collaboration. Our engineering team acts
              as an extension of yours, ensuring architectural excellence at
              every scale.
            </p>
          </div>
          ...
          <div className="support-grid">
            <div className="support-card card-fixed">
              ...
              <p className="card-description">
                Predictable budgeting with a flat-rate engineering model. No
                hidden costs for scaling your visibility.
              </p>
              ...
              <button className="btn-download">Download Pricing Guide</button>
            </div>
            ...
            <div className="support-card card-mission">
              ...
              <p className="card-description">
                For organizations where downtime isn't an option. Direct,
                high-speed access to our core SRE team.
              </p>
              ...
              <button className="btn-activate">Activate Elite Coverage</button>
            </div>
          </div>
        </div>
      </section>
